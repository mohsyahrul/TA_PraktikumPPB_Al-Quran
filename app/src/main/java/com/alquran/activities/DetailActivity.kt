...
import com.alquran.adapter.DetailAdapter
...
class DetailActivity : AppCompatActivity() {
    ...
    fun toggleExpansion(view: View?) {
        val expansionLayout = findViewById<LinearLayout>(com.alquran.R.id.expansionLayout)
        val arrow = findViewById<ImageView>(com.alquran.R.id.arrowIcon)

        if (expansionLayout.visibility == View.VISIBLE) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.alquran.R.layout.activity_detail)
